    ...
    <>
      ...
      >
        <p className="text-sm font-medium text-[var(--text)]">
          Snelste route naar een afspraak
        </p>
      ...
      <section className="mx-auto mt-12 max-w-4xl">
        <div className="grid gap-6 md:grid-cols-3">
          {[
            {
              title: "Rustig & persoonlijk",
              text: "Geen gehaast. We nemen de tijd zodat het echt voelt.",
            },
            {
              title: "Heldere afspraken",
              text: "Je weet vooraf wat je krijgt en wat het kost.",
            },
            {
              title: "Kwaliteit in levering",
              text: "Foto’s waar je jaren later nog blij van wordt.",
            },
          ].map((b) => (
            <div
              key={b.title}
