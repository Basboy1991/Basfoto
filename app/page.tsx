    ...
    <div className="space-y-10">
      <section className="space-y-4">
        ...
        <p className="max-w-2xl text-lg text-zinc-700">
          {siteConfig.tagline}. Geen stijve poses—wel echte momenten, op een plek waar jij je op je
          gemak voelt.
        </p>
      ...
      <section className="grid gap-6 md:grid-cols-3">
        {[
          {
            title: "Gezinnen",
            text: "Spontane foto’s waar jullie écht op staan zoals jullie zijn.",
          },
          { title: "Huisdieren", text: "Geduldige shoots met aandacht voor karakter en plezier." },
          {
            title: "Westland",
            text: "Buitenlocaties in de buurt: duinen, strand, park of gewoon bij jullie thuis.",
          },
        ].map((card) => (
